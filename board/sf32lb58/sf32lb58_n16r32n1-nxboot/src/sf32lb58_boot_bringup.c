...
#ifdef CONFIG_MTD
#ifdef CONFIG_BSP_USING_NAND_FLASH4
...
#elif CONFIG_BSP_USING_NOR_FLASH4
#  define SF32LB58_NOR_PART0_OFFSET  0x18000000  /* Primary slot */
#  define SF32LB58_NOR_PART0_SIZE    0x00400000  /* 4 MB */
#  define SF32LB58_NOR_PART1_OFFSET  0x18400000  /* Secondary slot */
#  define SF32LB58_NOR_PART1_SIZE    0x00400000  /* 4 MB */
#  define SF32LB58_NOR_PART2_OFFSET  0x18800000  /* Tertiary slot */
#  define SF32LB58_NOR_PART2_SIZE 0x00400000       /* 4 MB */
#else
#error Either NAND nor NOR defined
#endif
#endif /* CONFIG_MTD */
...
int sf32lb58_boot_bringup(void)
{
...
#ifdef CONFIG_MTD
  {
    ...
    static const uint32_t part_offsets[] =
    {
      SF32LB58_NOR_PART0_OFFSET,
      SF32LB58_NOR_PART1_OFFSET,
      SF32LB58_NOR_PART2_OFFSET
    };

    static const uint32_t part_sizes[] =
    {
      SF32LB58_NOR_PART0_SIZE,
      SF32LB58_NOR_PART1_SIZE,
      SF32LB58_NOR_PART2_SIZE
    };

    ret = sf32lb_flash_register_partitions(
            partnames, part_offsets, part_sizes, 3);
    if (ret < 0)
      {
        syslog(LOG_ERR, "ERROR: NAND partition registration failed: %d\n",
...
#endif /* CONFIG_BSP_USING_NAND_FLASH4 */  
  }
#endif /* CONFIG_MTD */
